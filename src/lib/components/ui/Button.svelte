<script>
    ...
    const defaultClasses = 'w-full flex items-center justify-center py-2.5 lg:py-3.5 mb-4 lg:mb-5 text-base font-medium rounded-lg transition focus:ring-2 focus:ring-color-ring focus:ring-offset-2 focus:outline-none';
