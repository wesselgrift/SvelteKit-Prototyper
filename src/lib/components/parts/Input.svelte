...
{#if type === 'text' || type === 'password' || type === 'email' || type === 'tel' || type === 'url' || type === 'search' || type === 'number' || type === 'date' || type === 'datetime-local' || type === 'month' || type === 'time' || type === 'week'}
    <input {name} {id} {type} {placeholder} {required} {disabled} class={baseTypeClasses} bind:value />
{:else if type === 'file'}
    <input {name} {id} {type} {placeholder} {required} {disabled} class={fileTypeClasses} bind:value {multiple} />
{:else if type === 'color'}
    <input {name} {id} {type} {placeholder} {required} {disabled} class={colorTypeClasses} bind:value />
{:else if type === 'range'}
    <input {name} {id} {type} {placeholder} {required} {disabled} class={rangeTypeClasses} bind:value />
{/if}
