...
<div class="w-full lg:flex lg:h-screen">
	<div class="animate-fade-in-zoom flex w-full items-start justify-center lg:w-1/2 lg:items-center">
		<div class="w-full max-w-md p-5">
            ...
            {/if}
			<h2 class="mb-4 text-2xl font-medium leading-tight text-color-foreground">Check your email</h2>
            <div class="flex flex-col gap-5 items-start">
                <p class="mb-2">We've sent a verification email to <span class="font-medium">{userEmail}</span>. Please check your email and click the link to verify your account.</p>
